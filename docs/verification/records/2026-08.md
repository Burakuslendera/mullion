...
- **Implementation / contract:** [Decision 0045](../../decisions/0045-required-document-created-script-registration-barrier.md)
  ...
  [verification checklist](../acceptance-checklist.md#manual-acceptance-checklist).
...
- **2026-08-31 final paired live acceptance:** The separately hashed untagged
  ...
  [paired live record](./issues/issue-135-paired-live.md).
...
> Last updated: 2026-09-04 | Editor: OpenAI (GPT-5.6) | Change: relocate the archived August verification record under canonical routing.
