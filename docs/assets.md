...
> Last updated: 2026-08-06 | Editor: OpenAI (GPT-5.6) | Change: split this asset-serving reference verbatim from webview2-and-assets.md at its hard limit, then added the standalone title and contents index.
