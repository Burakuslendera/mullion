...
> Last updated: 2026-08-10 | Editor: OpenAI (GPT-5.6) | Change: retain the portability correction record and add issue #125's explicit Windows/x64 fifth-lane contract, local evidence and successful exactly-five-job Actions run 31479374909.