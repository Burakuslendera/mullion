...
These dated records moved verbatim from
[`../verification-records.md`](../verification-records.md) when the 2026-09-02
issue #140 entry pushed that document past its 400-line reference cap. Entries
are unchanged; new records continue in the parent document, and later caps
split into further dated files in this folder — the pattern `docs/decisions/`
...
> Last updated: 2026-09-02 | Editor: ZCode (GLM-5.3-Flash) | Change: receive the 2026-08 records and the issue #113 record verbatim when verification-records.md hit the 400-line cap; relocated into the verification-records/ folder.
